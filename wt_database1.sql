...
--
-- Host: localhost
-- Generation Time: May 14, 2024 at 01:51 PM
...
CREATE TABLE `book` (
  ...
  `book_status` varchar(50) NOT NULL DEFAULT 'pending'
...
INSERT INTO `book` (`Username`, `Fname`, `Gender`, `CID`, `DID`, `DOV`, `Timestamp`, `Status`, `book_status`) VALUES
('user', 'patient', 'male', 1, 1, '2017-11-08', '2017-11-05 16:43:48', 'Booking Registered.Wait for the update', 'pending'),
('user', 'Juan Carlo', 'male', 1, 1, '2024-05-14', '2024-05-14 00:00:00', 'Booking Registered.Wait for the update', 'cancelled');
